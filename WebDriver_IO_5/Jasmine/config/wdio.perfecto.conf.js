...
var reportingClient;
const tags = [];
const securityToken = authenticator.getToken(cloud);
...
exports.config = {
    ...
    beforeSuite: function (suite) {
      console.log("beforeSuite() started")
      console.log(suite)
      console.log("beforeSuite() ended")
    },
    /**
     * Function to be executed before a test (in Mocha/Jasmine) starts.
     */
    beforeTest: function (test, context) {
      console.log("beforeTest() started")
      console.log("##############################################################")
      console.log("# Running test: " + test.fullName)
      console.log("##############################################################")
      browser.reportingClient.testStart('WebdriverIO Sample Test');
      console.log("beforeTest() ended")
    },
    /**
     * Function to be executed after a test (in Mocha/Jasmine).
     */
    afterTest: function(test, context, { error, result, duration, passed, retries }) {
      console.log("afterTest() started")
      if (passed === true) {
        browser.reportingClient.testStop({status: Reporting.Constants.results.passed });
      } else {
        message = browser.failureMessage ? browser.failureMessage : "Unknown error occured!"
    ...
    afterSuite: function (suite) {
      console.log("afterSuite() started")
      console.log("Finished execution of " + suite.file)
      console.log("afterSuite() ended")
    },
    /**
